...
import {
  ...
  useUncontrolled,
  useWillUnmount
} from "./chunk-FL3B26Z4.js";
import {
  require_classnames,
  useBootstrapPrefix
} from "./chunk-HMD2YGDL.js";
import {
  require_jsx_runtime
...
var NavbarCollapse = React5.forwardRef(({
  ...
  const context2 = (0, import_react2.useContext)(NavbarContext_default);
...
function getReactVersion() {
  const parts = React7.version.split(".");
  return {
    major: +parts[0],
    minor: +parts[1],
    patch: +parts[2]
...
var AbstractModalHeader = React16.forwardRef(({
  ...
  const context2 = (0, import_react13.useContext)(ModalContext_default);
...
var divWithClassName_default = (className) => React18.forwardRef((p, ref) => (0, import_jsx_runtime15.jsx)("div", {
  ...p,
  ref,
...
var Offcanvas = React20.forwardRef(({
  ...
  const renderBackdrop = (0, import_react14.useCallback)((backdropProps) => (0, import_jsx_runtime17.jsx)("div", {
    ...backdropProps,
...
var NavbarOffcanvas = React21.forwardRef(({
  onHide,
  ...props
}, ref) => {
  const context2 = (0, import_react15.useContext)(NavbarContext_default);
  const handleHide = useEventCallback(() => {
