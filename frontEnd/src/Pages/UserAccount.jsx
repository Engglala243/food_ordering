...
function UserProfile() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 font-mono">
      <div className="container mx-auto mt-14 py-12 px-4">
        <div className="bg-white shadow-md rounded-lg overflow-hidden">
          <div className="px-6 py-4 border-b">
            <h1 className="text-2xl font-bold text-gray-800">Your Account</h1>
            <p className="text-gray-600">Welcome back! Manage your account and settings below.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-6">
            ...
            >
              <h2 className="text-lg font-semibold text-blue-600">Your Orders</h2>
              <p className="text-sm text-gray-600">Track, return, or buy things again.</p>
            </button>

            <button
              className="p-4 bg-yellow-100 rounded-lg shadow hover:bg-yellow-200 focus:outline-none focus:ring focus:ring-yellow-300"
            >
              <h2 className="text-lg font-semibold text-yellow-600">Your Lists</h2>
            ...
            >
              <h2 className="text-lg font-semibold text-green-600">Your Profile</h2>
              <p className="text-sm text-gray-600">Manage your profile settings and preferences.</p>
            </button>
            ...
            >
              <h2 className="text-lg font-semibold text-green-600">Buy Again</h2>
              <p className="text-sm text-gray-600">Repurchase items you’ve previously bought.</p>
            </button>
