  ...
  return (
    <>
      <div className="relative flex flex-grow h-[100vh]">
              ...
              />
              <div className="absolute w-screen mt-44 flex flex-col gap-2 items-center justify-center">
                <div
                ...
                <div class="flex w-80 placeholder-white bg-transparent backdrop-blur-md text-white border border-white rounded-lg p-2 focus:outline-none">
                  <label>
